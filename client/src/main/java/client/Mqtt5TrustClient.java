...
public class Mqtt5TrustClient implements Mqtt5Client {
    ...
    public Mqtt5TrustClient(String host, int port, Opinions opinions) {
        this(Mqtt5Client.builder()
                .identifier(UUID.randomUUID().toString())
                .serverAddress(InetSocketAddress.createUnresolved(host, port))
                .automaticReconnect()
                .applyAutomaticReconnect(), opinions);
    }

    public Mqtt5TrustClient(Mqtt5ClientBuilder clientBuilder, Opinions opinions) {
