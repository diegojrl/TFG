...
import trust.db.Database;
import trust.db.Device;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import trust.trustControl.ControlSub;
...
import static trust.trustControl.ControlSub.VIEW_TOPIC;
import static trust.trustManagement.PingInterceptor.PING_TOPIC;
import static trust.trustManagement.ReputationListener.REPUTATION_TOPIC;
...
public class LifeCycleListener implements ClientLifecycleEventListener {
    ...
    public void onAuthenticationSuccessful(final @NotNull AuthenticationSuccessfulInput authenticationSuccessfulInput) {
        ...
        if (username.isPresent()) {
            try {
                ...
                log.debug("Authentication successful, added to truststore");
    ...
    public void onDisconnect(final @NotNull DisconnectEventInput disconnectEventInput) {
        ...
        log.debug("Client disconnected with id: {} ", disconnectEventInput.getClientInformation().getClientId());
    }
}
