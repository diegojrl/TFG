...
El proyecto tiene varios objetivos, todos relacionados con un sistema de control de acceso para IoT basando en la confianza y el protocolo MQTT. Se pueden desglosar como:
- Creación de un modelo de confianza apropiado para MQTT.
- Implementar un sistema de control de acceso y un procolo de control como una extensión del broker HiveMQ, basado en el modelo de confianza descrito anteriormente.
