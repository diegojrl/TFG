La aplicación web se ha desarrollado principalmente usando TypeScript @typescript, Svelte @svelte y MQTT.js @mqttjs, un cliente MQTT creado en typsecript, perfecto para el uso en una página web.
...
Al recibir datos, primero se decodifican usando la biblioteca msgpack-javascript @msgpack, para luego actualizar los datos de este dispositvo en la vista del usuario.
